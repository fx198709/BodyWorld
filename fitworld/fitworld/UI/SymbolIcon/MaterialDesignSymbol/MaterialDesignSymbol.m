...
+ (UIImage *)imageWithCode:(NSString *)code fontSize:(CGFloat)fontSize fontColor:(UIColor*)fontColor {
  MaterialDesignSymbol *symbol = [MaterialDesignSymbol iconWithCode:code fontSize:fontSize];
  [symbol addAttribute:NSForegroundColorAttributeName value:fontColor];
  return [symbol image];
}
