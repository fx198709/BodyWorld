...
- (void)addsubviews{
    ...
    [topImgView sd_setImageWithURL: [NSURL URLWithString:picUrl] placeholderImage:nil];
...
//    topimagBotBackView.backgroundColor = UIColor.redColor;
    ...
    startString = [NSString stringWithFormat:@"%@     %@",startString,ChineseStringOrENFun(@"交流语言：", @"Speaking")];
...
//    滚动条
    ...
    getKcalLabel.text = [NSString stringWithFormat:@"%ld", _selectRoom.calorie];
