...
IJK_EXTERN NSString *const IJKMPMoviePlayerVSVideoEventTypeKey;
IJK_EXTERN NSString *const IJKMPMoviePlayerVSVideoEventArgKey;
IJK_EXTERN NSString *const IJKMPMoviePlayerVSVideoEvent;
@end
